 ...
 *
 * Lab 4 - Implementing blocked senders queue. Each process has its own queue,
 *         so a head and a tail must be allocated for each process. Due to the
 *         fact that a process can only be in one queue at a time, no further
